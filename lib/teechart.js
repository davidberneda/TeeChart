  ...
  */
  ...
  Tee.CustomBar = function (o, o2) {
    ...
    this.calcBarOffset = function (axisSize) {
	  ...
	  if (this.notmandatory.dateTime) {
	    if (len > 1) barSize /= len;	  
	  }
	  else {
		var axisLength = this.notmandatory.endPos-this.notmandatory.startPos;
	    var range = Math.round(axisLength / this.notmandatory.scale) + 1;  

        barSize = axisLength / range;		
	  }
      ...
      if (this.stacked == "no") {
        ...
        offset.x =
          ...
          (visibleBar.total == 1
            ? -0.5
            : visibleBar.index - visibleBar.total * 0.5);
      ...
      this._margin =
        0.5 * tmpLen * offset.y +
        this.sideMargins * (tmpLen * (barSize - offset.y)) * 0.005;
